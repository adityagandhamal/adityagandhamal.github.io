...
<div class="proj-card">
  ...
  <div class="proj-media">
    ...
    <p class="media-caption">Bias reduction before and after adversarial training, measured via Equalized Odds.</p>
  </div>
  ...
  <div class="proj-media">
    <div class="media-grid">
      <div class="media-grid-item">
        ...
        <p class="media-caption">Actual satellite trajectory over 18 days (ground truth).</p>
      </div>
      <div class="media-grid-item">
        <video autoplay loop muted playsinline style="width:100%; height:180px; object-fit:cover; border-radius:5px; border:1px solid #e0e0e0;">
